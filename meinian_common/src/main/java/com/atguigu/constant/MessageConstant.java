...
public class MessageConstant {
    ...
    public static final String ADD_TRAVELGROUP_FAIL = "新增跟团游失败";
    public static final String ADD_TRAVELGROUP_SUCCESS = "新增跟团游成功";
    public static final String DELETE_TRAVELGROUP_FAIL = "删除跟团游失败";
    public static final String DELETE_TRAVELGROUP_SUCCESS = "删除跟团游成功";
    public static final String QUERY_TRAVELGROUP_SUCCESS = "查询跟团游成功";
    public static final String QUERY_TRAVELGROUP_FAIL = "查询跟团游失败";
    public static final String EDIT_TRAVELGROUP_FAIL = "编辑跟团游失败";
    public static final String EDIT_TRAVELGROUP_SUCCESS = "编辑跟团游成功";
